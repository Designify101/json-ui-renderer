...
export function InteractiveAreaChart({ data: propData, config: propConfig, className }: InteractiveAreaChartProps) {
    ...
    <Card className={`pt-0 ${className || ""}`}>
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>Showing total visitors for the {getTimeRangeLabel().toLowerCase()}</CardDescription>
        </div>
        {isMounted ? (
          ...
          <div className="hidden w-[160px] h-10 rounded-lg border border-input bg-background sm:ml-auto sm:flex items-center px-3">
