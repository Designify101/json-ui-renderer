...
export const description = "A radar chart with multiple data series"
...
function ChartRadarMultipleInternal({ data = chartData, config = chartConfig }: ChartRadarMultipleProps) {
...
export const ChartRadarMultiple = dynamic(() => Promise.resolve(ChartRadarMultipleInternal), {
  ssr: false,
  loading: () => (
