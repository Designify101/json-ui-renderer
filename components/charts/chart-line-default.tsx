...
export const description = "A basic line chart showing monthly data"
...
function ChartLineDefaultInternal({ data = chartData, config = chartConfig }: ChartLineDefaultProps) {
...
export const ChartLineDefault = dynamic(() => Promise.resolve(ChartLineDefaultInternal), {
  ssr: false,
  loading: () => (
